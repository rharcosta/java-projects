...
public class Novo_Usuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Insira as seguintes informações");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (conbd.getConnection()) {
            try {//Tratamento de erros
                String query = "INSERT INTO Login (Codigo, Usuario, Senha) VALUES (?,?,?)";
                PreparedStatement stmt = (PreparedStatement) conbd.con.prepareStatement(query);
                stmt.setString(1, TxtCod.getText());
                stmt.setString(2, TxtUsuario.getText().toUpperCase());
