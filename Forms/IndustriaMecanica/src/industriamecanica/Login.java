...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Digite para entrar");

        jLabel6.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        jLabel6.setText(" Clique aqui");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (conbd.getConnection()){
            try{//Tratamento de erros
                ...
                RS.close();
                stmt.close();
                conbd.close(); //Fecha Conexão com o BD
            }catch(SQLException e){//Trata os erros
                JOptionPane.showMessageDialog(this, "Erro Comando SQL"+e.getMessage());
            }
        }
        else JOptionPane.showMessageDialog(this, "Erro ao conectar!");
